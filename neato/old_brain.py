...
from old_hyperparameters import *
from old_species import *
import pickle
...
class OldBrain(object):
    ...
    """
    def __init__(self, inputs, outputs, population=100, hyperparams=OldHyperparameters()):
        self._inputs = inputs
    ...
    def classify_genome(self, genome):
        ...
        if not self._species:
            # Empty population
            self._species.append(OldSpecie(
